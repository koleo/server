...
public:
  ...
  int open_item_sum_func_internal(
    Item_sum *item_sum,
    ha_spider *spider,
    spider_string *str,
    const char *alias,
...
class spider_db_odbc_row: public spider_db_row
{
public:
  spider_string       *row;
  uint32              *len;
...
public:
  ...
  char                stored_error_msg[80];
  longlong            limit;
  spider_db_odbc_result(
    SPIDER_DB_CONN *in_db_conn
  );
  virtual ~spider_db_odbc_result();
  int init();
...
class spider_db_odbc: public spider_db_conn
{
protected:
  int                 stored_error;
  char                stored_error_msg[80];
  spider_db_odbc_util *utility;
public:
  SQLHANDLE      henv;
  SQLHANDLE      hdbc;
  SQLHSTMT       hstm;
...
class spider_odbc_share: public spider_db_share
{
protected:
  spider_db_odbc_util *utility;
public:
...
class spider_odbc_handler: public spider_db_handler
{
protected:
  int                     stored_error;
  char                    stored_error_msg[80];
...
class spider_odbc_copy_table: public spider_db_copy_table
{
public:
  spider_db_odbc_util     *utility;
  spider_odbc_share       *odbc_share;
